...
const Section4 = () => {
  ...
  return (
    <section className='w-full h-[1000px] bg-[#e5f77d]'>
      ...
      <div className='w-full flex'>
        ...
        <div className='w-5/12 mt-10'>
          <div>
            <div className={`text-5xl font-serif text-[#ccdc6f]  hover:text-black duration-200 ${open === 1 ? 'active' : ''}`} onClick={() => operation(1)}>
              BREEAM EXCELLENT
            </div>
            {open === 1 &&
              <div className='mt-64'>
