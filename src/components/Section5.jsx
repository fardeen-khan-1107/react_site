    ...
    <section className='my-20'>
       ...
       <div className='w-full flex mt-12'>
          <div className='w-1/2'>
              ...
              <div className='ml-10 weight-700 leading-5 text-xl'>
              The flexible divisible office space <br /> located on the second floor includes <br />
               approx. 1,472 square meters LFA. A <br /> combination of fixed workstations, <br />
                boardrooms and collaborative spaces <br />
                 caters to all working styles. On this <br />
                  floor, you will find options for working <br />
                   alone as well as working together. And  <br />
                   of course there is plenty of space for <br />
                    relaxation in between meetings and <br />
                    meeting your next deadline – from <br />
                    informal sitting areas to a trendy coffee <br />
                     corner. 
              </div>
              <div className='ml-10 my-20 weight-700 leading-5 text-xl'>
              With a WELL-gold certified indoor <br />
               climate and unique features, offices <br />
                located on the second floor truly  <br />
                prioritize your employees’ needs. All <br />
                 workspaces are centered around <br />
                  offering beautiful views from every <br />
                   office and a great quality/ price ratio. <br />
                    The CubeHouse offers tenants a <br />
                     sustainable, creative and productive <br />
                      environment that empowers them to <br />
                       reach their full potential and drive <br />
          ...
          <div className='w-1/2'>
            <img src={img11} alt="img11" className='w-74 h-5/6' />
          </div>
          </div>:null
        }
          </div>
       ...
       <div className='w-full flex mt-12'>
          <div className='w-1/2'>
              ...
              With a WELL-gold certified indoor <br />
               climate and unique features, offices <br />
                located on the second floor truly prioritize <br />
                 your employees’ needs. All
                 workspaces <br />are centered around 
                  offering beautiful<br /> views from every 
                   office and a great <br /> quality/ price ratio. 
                    The CubeHouse <br />offers tenants a 
                     sustainable, creative <br />and productive 
                      environment that <br />empowers them to 
                       reach their full<br /> potential and <br />drive 
                       collaboration and innovation. 
              </div>
              <div className='text-sm border-2 border-solid border-[#cfcfce] py-3 px-20 w-72 ml-10'>
                Download floorplan
          ...
          <div className='w-1/2'>
            <img src={img12} alt="img12" className='w-74 h-5/6' />
          </div>
          </div>:null
        }
          </div>
